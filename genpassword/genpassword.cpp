...
// genpassword.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CgenpasswordApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CgenpasswordApp

CgenpasswordApp::CgenpasswordApp()
{
...
// Единственный объект CgenpasswordApp

CgenpasswordApp theApp;


// Инициализация CgenpasswordApp

BOOL CgenpasswordApp::InitInstance()
{
